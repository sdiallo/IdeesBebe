class AssetsController < ApplicationController
  ...
  def become_starred
    if @asset.become_starred
      flash[:notice] = I18n.t('assets.become_starred.success')
    else
      flash[:error] = I18n.t('assets.become_starred.error')
    end
  ...
  def destroy
    ...
    if @asset.destroy
      flash[:notice] = I18n.t('assets.destroy.success')
    else
      flash[:error] = I18n.t('assets.destroy.error')
    end
